...
/**
 @Module Name : M_SpecTypes
 @Description : Type system for HotStuff
 */
module M_SpecTypes {
  ...
  datatype Block = Block(blockId : nat, parent : Block) | EmptyBlock
  ...
  const Genesis_Block : Block := Block(0, EmptyBlock)
